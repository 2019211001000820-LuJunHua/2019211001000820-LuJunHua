		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.LuJunHua.model.Order o=(com.LuJunHua.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("dbConn");
						com.LuJunHua.dao.UserDao userDao=new com.LuJunHua.dao.UserDao();
						String customerName=userDao.findById(con, userId).getUsernamne();
					%>
					<td><%=customerName %></td>
					<td>
					...
					<td class="cart_total">${o.paymentId}
						<%
							...
							String paymentType=com.LuJunHua.model.Payment.findByPaymentId(con,n);
						%>
